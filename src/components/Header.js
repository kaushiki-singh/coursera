    ...
    return (
        <div className="header">
            <div className="logo">
             ...
             <Button class="btn-color" style={{ color:"white", backgroundColor:"rgb(0, 86, 210)"}}>Explore <ExpandMoreIcon/></Button>{' '}
            <div className="search">
                <input className="search_input" placeholder="What do you want to learn?"/>
                <SearchIcon className="search_icon"/>
            </div>
            <a href="" className="enterprise">For Enterprise</a>
            <a href="" className="enterprise">For Students</a>
            <a href="" className="login enterprise">Log In</a>
            <Button style={{color:"white", background:"rgb(0, 86, 210)"}}>Join for Free</Button>
